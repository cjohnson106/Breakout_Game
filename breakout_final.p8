...
__lua__
-- breakout hero
-- forked from layz devs

-- Water Breakout
-- Continued by Cannon Johnson

-- ? difficult to redirect the ball

-- THINGS TO CHANGE STILL:
-- 4. New music
-- 8. Toggle Camera Shake? (Not enough tokens to make it functional)
...
function doblink()
 local start_seq = {1,12,7,12}
 local w_seq = {5,6,7,6}
 local b_seq = {1,13,7,13,1}
 local r_seq = {7,12,13,12}
 local fast_seq = {8,2,8,6}
 blinkframe+=1 
 if blinkframe>blinkspeed then
  blinkframe=0

  blink_start_i+=1
  if blink_start_i > #start_seq then
   blink_start_i=1
  end
  blink_start=start_seq[blink_start_i]

  blink_fast_i+=1
  if blink_fast_i > #fast_seq then
   blink_fast_i=1
  end
  blink_fast=fast_seq[blink_fast_i]
...
function spawntrail(_x,_y)
 if rnd()<0.5 then
  ...
  addpart(_x+_ox,_y+_oy,0,0,0,15+rnd(15),{7,12},0)
 end
end
...
function draw_start()
 ...
 if hs_x>=0 and not(pirate) then
  if fastmode then
   print("fast mode",46,84,blink_fast)
  end  

  print("press ❎ to start",30,92,blink_start)
  print("press ⬆️⬇️ to toggle fast mode",9,115,8)
  if hs_x==128 then
   print("press ⬅️ for high score list",9,109,7)
  end
 end
...
function draw_gameover()
 ...
 print("dead man tell no tales",22,62,8)
 if govercountdown<0 then
...
__gfx__

...

...

__label__
